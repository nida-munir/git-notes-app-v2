...
import { updateLocalStorage, updateIsLoading, updateGists } from '../../action-creators/index';
import './Welcome.css';
...
class Welcome extends Component<WelcomeProps> {
	...
	onFailure = (response: any) => {
		console.log('Error while getting code from GitHub. Please try again later.', response);
	};
...
type WelcomeDispatchProps = Pick<WelcomeProps, 'history' | 'updateGists' | 'updateLocalStorage' | 'updateIsLoading'>;

function mapStateToProps(state: ApplicationState, ownProps: any): WelcomeStateProps {
...
function mapDispatchToProps(dispatch: Dispatch<any>, ownProps: any): WelcomeDispatchProps {
	return {
